...
function prepara_sketch() {
  ...
  if (mi_m[3] < 0.65) {
    ...
    if (_r < 0.35) {
      ...
      grilla = [];
      if (_r < 0.48) grilla = [[0, 0], [-100, 0], [100, -100], [0, -100], [-100, -100], [100, 100], [0, 100], [-100, 100], [100, 0]];
      else if (_r < 0.61) grilla = [[0, 0], [100, 100], [0, 100], [-100, 100], [-100, 0], [-100, -100], [0, -100], [100, -100], [100, 0]];
      else if (_r < 0.74) grilla = [[0, 0], [100, -100], [0, -100], [-100, -100], [-100, 0], [-100, 100], [0, 100], [100, 100], [100, 0]];
      else if (_r < 0.87) grilla = [[0, 0], [100, 100], [-100, 100], [0, 0], [100, -100], [-100, -100]];
